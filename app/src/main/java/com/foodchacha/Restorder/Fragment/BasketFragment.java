...
import com.foodchacha.Restorder.Activity.CheckoutActivity;
import com.foodchacha.Restorder.Activity.MainActivity;
import com.foodchacha.Restorder.Activity.MainBottomNavigationActivity;
import com.foodchacha.Restorder.Adapter.BasketAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		btnShopping.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(getActivity(), MainBottomNavigationActivity.class);
