...
import com.foodchacha.Restorder.Adapter.CheckoutAdapter;
...
import com.foodchacha.Restorder.CommonClass.Utility;
...
public class CheckoutActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    private TextView tvSubTotal,tvTitle;
            ...
            public void onResponse(Call<ResponsePayment> call, Response<ResponsePayment> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().code == Constant.Response_OK) {
                        cc.showToast(response.body().message);
                        preferenceUtils.setCartCount("0");
                        Intent intent = new Intent(CheckoutActivity.this, MainBottomNavigationActivity.class);
