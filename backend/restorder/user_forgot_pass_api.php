	...
	include('includes/function.php');
		...
		if($row['email']!="")
		{
			...
			@mail($to, $subject, $message, $headers);
		  	$set['response']->message = 'successful send password';
			$set['response']->code = 200;    	  
			$set['forget_password']=array('success'=>'1');
			//$set['forget_password'][]=array('msg' => "Password has been sent on your mail!",'success'=>'1');
		}
		else
		{  	 
			$set['response']->message = 'Email not exist';
			$set['response']->code = 404; 	
			//$set['forget_password']=array('msg' => "Email not found in our database!",'success'=>'0');
			//$set['forget_password'][]=array('msg' => "Email not found in our database!",'success'=>'0');
