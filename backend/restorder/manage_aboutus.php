...
<div class="page-header">
	...
	<div class="page-header-content">
		<div class="page-title">
			<h4><span class="text-semibold">About Description</span></h4>
		</div>
		
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="add_aboutus.php?add=yes" class="btn btn-link btn-float has-text"><i class=" icon-plus3 text-primary"></i><span>Add Detail</span></a>				
			</div>
		</div>
	</div>
</div>
			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">About Description</h5>
									...
									<ul class="icons-list">
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="add_aboutus.php?cat_id=<?php echo $row['id'];?>"><i class="glyphicon glyphicon-edit"></i> EDIT</a></li>
